...
interface ChallengeStore {
    void listChallenges(OnChallengeListReceivedListener listener);
...
class ServerChallengeStore implements ChallengeStore{
    ...
    @Override
    public void listChallenges(@NonNull final OnChallengeListReceivedListener listener) {
    ...
    public void addChallenge(Challenge challenge, @NonNull final OnChallengeAddedListener listener) {
        ...
        try {
            ...
            json.put("author_id", 1); //TODO: Make this insert the actual userid
        } catch (JSONException e) {
            e.printStackTrace();
        }
